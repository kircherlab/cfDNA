...
rule add_flanks:
    ...
    output:
        "results/intermediate/{ID}/regions/target_region/{target_region}_flanking.bed"
    params:
        flank=3000+1000
    shell:
        """
...
checkpoint exclude_blacklist:
    input:
        Region_file = "results/intermediate/{ID}/regions/target_region/{target_region}_flanking.bed",
